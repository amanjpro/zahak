...
func TestBishopMoves(t *testing.T) {
	...
	bbSlidingMoves(board.whiteBishop, board.whitePieces, board.blackPieces, board.blackKing,
		White, bishopAttacks, false, add, false, nil)
	expectedMoves := []*Move{
		&Move{E2, F1, NoType, 0},
		&Move{E2, F3, NoType, 0},
		&Move{E2, G4, NoType, 0},
...
func TestRookMoves(t *testing.T) {
	...
	bbSlidingMoves(board.whiteRook, board.whitePieces, board.blackPieces, board.blackKing,
		White, rookAttacks, false, add, false, nil)
	expectedMoves := []*Move{
		&Move{H1, G1, NoType, 0},
		&Move{H1, F1, NoType, 0},
		&Move{C1, C2, NoType, 0},
...
func TestQueenMoves(t *testing.T) {
	...
	bbSlidingMoves(board.whiteQueen, board.whitePieces, board.blackPieces, board.blackKing,
		White, queenAttacks, false, add, false, nil)
	expectedMoves := []*Move{
		&Move{D1, D2, NoType, 0},
		&Move{D1, D3, NoType, 0},
...
func TestKingMoves(t *testing.T) {
	...
	bbKingMoves(board.whiteKing, board.whitePieces, board.blackPieces, board.blackKing,
		taboo, color, p.HasTag(WhiteCanCastleKingSide), p.HasTag(WhiteCanCastleQueenSide), false, add, false, nil)
	expectedMoves := []*Move{
...
func TestPawnMovesForWhite(t *testing.T) {
	...
	bbPawnMoves(board.whitePawn, board.whitePieces, board.blackPieces,
		board.blackKing, color, p.EnPassant, false, add, false, nil)
	expectedMoves := []*Move{
		&Move{H2, H4, NoType, 0},
		&Move{H2, H3, NoType, 0},
		&Move{F2, F4, NoType, 0},
...
func TestPawnMovesForBlack(t *testing.T) {
	...
	bbPawnMoves(board.blackPawn, board.blackPieces, board.whitePieces,
		board.whiteKing, color, p.EnPassant, false, add, false, nil)
	expectedMoves := []*Move{
		&Move{H7, H6, NoType, 0},
		&Move{H7, H5, NoType, 0},
		&Move{G7, G6, NoType, 0},
...
func TestKnightMoves(t *testing.T) {
	...
	bbKnightMoves(b.whiteKnight, b.whitePieces, b.blackPieces, b.blackKing, false, add, false, nil)
	expectedMoves := []*Move{
		&Move{G3, F1, NoType, 0},
		&Move{G3, E4, NoType, 0},
		&Move{G3, F5, NoType, 0},
