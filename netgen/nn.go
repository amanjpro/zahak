...
func main() {
	...
	f.WriteString("CurrentHiddenWeights = [NetInputSize * NetHiddenSize]float32 {\n")
	...
	f.WriteString("CurrentHiddenBiases = [NetHiddenSize]float32 {\n")
	...
	f.WriteString("CurrentOutputWeights = [NetHiddenSize]float32 {\n")
