...
func computeInitialGuesses() []int16 {
	...
	guesses = append(guesses, MiddlegameInnerPawnShieldReward)         // 806
	guesses = append(guesses, EndgameInnerPawnShieldReward)            // 807
	guesses = append(guesses, MiddlegameOuterPawnShieldReward)         // 808
	guesses = append(guesses, EndgameOuterPawnShieldReward)            // 809
	guesses = append(guesses, MiddlegameNotCastlingPenalty)            // 810
	guesses = append(guesses, EndgameNotCastlingPenalty)               // 811
	guesses = append(guesses, MiddlegameKingZoneMissingOwnPawnPenalty) // 812
	guesses = append(guesses, EndgameKingZoneMissingOwnPawnPenalty)    // 813
	// guesses = append(guesses, MiddlegameKingZoneOpponentPawnMissingPenalty) // 814
	// guesses = append(guesses, EndgameKingZoneOpponentPawnMissingPenalty)    // 815
...
func updateEvalParams(guesses []int16) {
	...
	MiddlegameInnerPawnShieldReward = guesses[806]
	EndgameInnerPawnShieldReward = guesses[807]
	MiddlegameOuterPawnShieldReward = guesses[808]
	EndgameOuterPawnShieldReward = guesses[809]
	MiddlegameNotCastlingPenalty = guesses[810]
	EndgameNotCastlingPenalty = guesses[811]
	MiddlegameKingZoneMissingOwnPawnPenalty = guesses[812]
	EndgameKingZoneMissingOwnPawnPenalty = guesses[813]
	// MiddlegameKingZoneOpponentPawnMissingPenalty = guesses[814]
	// EndgameKingZoneOpponentPawnMissingPenalty = guesses[815]
}
...
func printOptimalGuesses(guesses []int16) {
	...
	fmt.Printf("var MiddlegameInnerPawnShieldReward int16 = %d\n", guesses[806])
	fmt.Printf("var EndgameInnerPawnShieldReward int16 = %d\n", guesses[807])
	fmt.Printf("var MiddlegameOuterPawnShieldReward int16 = %d\n", guesses[808])
	fmt.Printf("var EndgameOuterPawnShieldReward int16 = %d\n", guesses[809])
	fmt.Printf("var MiddlegameNotCastlingPenalty int16 = %d\n", guesses[810])
	fmt.Printf("var EndgameNotCastlingPenalty int16 = %d\n", guesses[811])
	fmt.Printf("var MiddlegameKingZoneMissingOwnPawnPenalty int16 = %d\n", guesses[812])
	fmt.Printf("var EndgameKingZoneMissingOwnPawnPenalty int16 = %d\n", guesses[813])
	// fmt.Printf("var MiddlegameKingZoneOpponentPawnMissingPenalty int16 = %d\n", guesses[814])
	// fmt.Printf("var EndgameKingZoneOpponentPawnMissingPenalty int16 = %d\n", guesses[815])
